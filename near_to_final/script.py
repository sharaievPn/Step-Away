...
def create_map_ukrainian(latitude, longitude) -> None:
    """
    The func create map on ukrainian language
    :param latitude: coordinate of user
    ...
    m.get_root().html.add_child(folium.Element(check_box_ukr))
    m.add_child(fg)
...
def create_map_english(latitude, longitude):
    ...
    m.get_root().html.add_child(folium.Element(check_box_eng))
    m.add_child(fg)
